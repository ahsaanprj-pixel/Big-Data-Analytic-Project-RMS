...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        if os.path.exists(icon_path):
            ...
            print("⚠️ icon_m.png not found")

        # ======= Menu Bar =======
        self.menubar = tk.Menu(self.m_frame)
        self.filebar = tk.Menu(self.menubar, tearoff=0)

        # original menu commands (commented out — future weeks)
        ...
        self.filebar.add_command(label="Create Orders", state=tk.DISABLED)
        self.filebar.add_command(label="Configure Facility/Menu", state=tk.DISABLED)
        ...
        if os.path.exists(img_path):
            ...
            print("⚠️ main_win_ph.png not found")
            self.panel = tk.Label(
                self.m_frame,
                text="Restaurant Management System",
                font=("Helvetica Bold", 20),
    ...
    # ====== Original methods (commented for later weeks) ======
